// GLYPH compositor test: RIME-I + GLYPH
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[12] = 32'h0ca00313;
        bram[13] = 32'h0062a023;
        bram[14] = 32'h300002b7;
        bram[15] = 32'h00828293;
        bram[16] = 32'h0002a403;
        bram[17] = 32'h03100513;
        bram[18] = 32'hfc5ff0ef;
        bram[19] = 32'h00100293;
        bram[20] = 32'h00541863;
        bram[21] = 32'h05000513;
        bram[22] = 32'hfb5ff0ef;
        bram[23] = 32'h00c0006f;
        bram[24] = 32'h04600513;
        bram[25] = 32'hfa9ff0ef;
        bram[26] = 32'h00000913;
        bram[27] = 32'h300002b7;
        bram[28] = 32'h03700313;
        bram[29] = 32'h0062a023;
        bram[30] = 32'h300002b7;
        bram[31] = 32'h00428293;
        bram[32] = 32'h00100313;
        bram[33] = 32'h0062a023;
        bram[34] = 32'h300002b7;
        bram[35] = 32'h00828293;
        bram[36] = 32'h0002a403;
        bram[37] = 32'h03700293;
        bram[38] = 32'h00541463;
        bram[39] = 32'h0080006f;
        bram[40] = 32'h00190913;
        bram[41] = 32'h300002b7;
        bram[42] = 32'h0ff00313;
        bram[43] = 32'h0062a023;
        bram[44] = 32'h300002b7;
        bram[45] = 32'h00828293;
        bram[46] = 32'h0002a403;
        bram[47] = 32'h0ff00293;
        bram[48] = 32'h00541463;
        bram[49] = 32'h0080006f;
        bram[50] = 32'h00190913;
        bram[51] = 32'h300002b7;
        bram[52] = 32'h00100313;
        bram[53] = 32'h0062a023;
        bram[54] = 32'h300002b7;
        bram[55] = 32'h00828293;
        bram[56] = 32'h0002a403;
        bram[57] = 32'h00100293;
        bram[58] = 32'h00541463;
        bram[59] = 32'h0080006f;
        bram[60] = 32'h00190913;
        bram[61] = 32'h03200513;
        bram[62] = 32'hf15ff0ef;
        bram[63] = 32'h00091863;
        bram[64] = 32'h05000513;
        bram[65] = 32'hf09ff0ef;
        bram[66] = 32'h00c0006f;
        bram[67] = 32'h04600513;
        bram[68] = 32'hefdff0ef;
        bram[69] = 32'h300002b7;
        bram[70] = 32'h05300313;
        bram[71] = 32'h0062a023;
        bram[72] = 32'h300002b7;
        bram[73] = 32'h01428293;
        bram[74] = 32'h00200313;
        bram[75] = 32'h0062a023;
        bram[76] = 32'h300002b7;
        bram[77] = 32'h01828293;
        bram[78] = 32'h0002a303;
        bram[79] = 32'hfe030ee3;
        bram[80] = 32'h300002b7;
        bram[81] = 32'h00c28293;
        bram[82] = 32'h0002a403;
        bram[83] = 32'h300002b7;
        bram[84] = 32'h0082a023;
        bram[85] = 32'h300002b7;
        bram[86] = 32'h00428293;
        bram[87] = 32'h05300313;
        bram[88] = 32'h0062a023;
        bram[89] = 32'h300002b7;
        bram[90] = 32'h00828293;
        bram[91] = 32'h0002a483;
        bram[92] = 32'h03300513;
        bram[93] = 32'he99ff0ef;
        bram[94] = 32'h00100293;
        bram[95] = 32'h00549863;
        bram[96] = 32'h05000513;
        bram[97] = 32'he89ff0ef;
        bram[98] = 32'h00c0006f;
        bram[99] = 32'h04600513;
        bram[100] = 32'he7dff0ef;
        bram[101] = 32'h00a00513;
        bram[102] = 32'he75ff0ef;
        bram[103] = 32'h002002b7;
        bram[104] = 32'hfff28293;
        bram[105] = 32'hfe029ee3;
        bram[106] = 32'he75ff06f;
    end
endmodule

// WEAVE compositor test: RIME-I + WEAVE
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[14] = 32'h0122a023;
        bram[15] = 32'h300002b7;
        bram[16] = 32'h01028293;
        bram[17] = 32'h0002a303;
        bram[18] = 32'h00137313;
        bram[19] = 32'hfe030ce3;
        bram[20] = 32'h300002b7;
        bram[21] = 32'h00c28293;
        bram[22] = 32'h0002a983;
        bram[23] = 32'h00008067;
        bram[24] = 32'h06400413;
        bram[25] = 32'h0c800493;
        bram[26] = 32'h00000913;
        bram[27] = 32'hfb1ff0ef;
        bram[28] = 32'h03100513;
        bram[29] = 32'hf99ff0ef;
        bram[30] = 32'h12c00293;
        bram[31] = 32'h00599863;
        bram[32] = 32'h05000513;
        bram[33] = 32'hf89ff0ef;
        bram[34] = 32'h00c0006f;
        bram[35] = 32'h04600513;
        bram[36] = 32'hf7dff0ef;
        bram[37] = 32'h1f400413;
        bram[38] = 32'h07b00493;
        bram[39] = 32'h00100913;
        bram[40] = 32'hf7dff0ef;
        bram[41] = 32'h03200513;
        bram[42] = 32'hf65ff0ef;
        bram[43] = 32'h17900293;
        bram[44] = 32'h00599863;
        bram[45] = 32'h05000513;
        bram[46] = 32'hf55ff0ef;
        bram[47] = 32'h00c0006f;
        bram[48] = 32'h04600513;
        bram[49] = 32'hf49ff0ef;
        bram[50] = 32'h00700413;
        bram[51] = 32'h00d00493;
        bram[52] = 32'h00200913;
        bram[53] = 32'hf49ff0ef;
        bram[54] = 32'h00000e13;
        bram[55] = 32'h05b00293;
        bram[56] = 32'h00598463;
        bram[57] = 32'h001e0e13;
        bram[58] = 32'h0aa00413;
        bram[59] = 32'h05500493;
        bram[60] = 32'h00500913;
        bram[61] = 32'hf29ff0ef;
        bram[62] = 32'h0ff00293;
        bram[63] = 32'h00598463;
        bram[64] = 32'h001e0e13;
        bram[65] = 32'h03300513;
        bram[66] = 32'hf05ff0ef;
        bram[67] = 32'h000e1863;
        bram[68] = 32'h05000513;
        bram[69] = 32'hef9ff0ef;
        bram[70] = 32'h00c0006f;
        bram[71] = 32'h04600513;
        bram[72] = 32'heedff0ef;
        bram[73] = 32'h00a00513;
        bram[74] = 32'hee5ff0ef;
        bram[75] = 32'h002002b7;
        bram[76] = 32'hfff28293;
        bram[77] = 32'hfe029ee3;
        bram[78] = 32'hf29ff06f;
    end
endmodule

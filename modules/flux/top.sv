// FLUX compositor test: RIME-I + FLUX
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[12] = 32'h00c28293;
        bram[13] = 32'h10000313;
        bram[14] = 32'h0062a023;
        bram[15] = 32'h300002b7;
        bram[16] = 32'h01028293;
        bram[17] = 32'h0002a023;
        bram[18] = 32'h300002b7;
        bram[19] = 32'h01428293;
        bram[20] = 32'h0002a023;
        bram[21] = 32'h300002b7;
        bram[22] = 32'h06400313;
        bram[23] = 32'h0062a023;
        bram[24] = 32'h300002b7;
        bram[25] = 32'h00428293;
        bram[26] = 32'h05000313;
        bram[27] = 32'h0062a023;
        bram[28] = 32'h300002b7;
        bram[29] = 32'h00828293;
        bram[30] = 32'h0002a403;
        bram[31] = 32'h03100513;
        bram[32] = 32'hf8dff0ef;
        bram[33] = 32'h00f00293;
        bram[34] = 32'h00544c63;
        bram[35] = 32'h01900293;
        bram[36] = 32'h00545863;
        bram[37] = 32'h05000513;
        bram[38] = 32'hf75ff0ef;
        bram[39] = 32'h00c0006f;
        bram[40] = 32'h04600513;
        bram[41] = 32'hf69ff0ef;
        bram[42] = 32'h300002b7;
        bram[43] = 32'h01828293;
        bram[44] = 32'h00100313;
        bram[45] = 32'h0062a023;
        bram[46] = 32'h300002b7;
        bram[47] = 32'h0002a023;
        bram[48] = 32'h300002b7;
        bram[49] = 32'h00428293;
        bram[50] = 32'h06400313;
        bram[51] = 32'h0062a023;
        bram[52] = 32'h300002b7;
        bram[53] = 32'h00828293;
        bram[54] = 32'h0002a403;
        bram[55] = 32'h03200513;
        bram[56] = 32'hf2dff0ef;
        bram[57] = 32'hfa600293;
        bram[58] = 32'h00545c63;
        bram[59] = 32'hf9200293;
        bram[60] = 32'h00544863;
        ...
        bram[67] = 32'h01828293;
        bram[68] = 32'h00100313;
        bram[69] = 32'h0062a023;
        bram[70] = 32'h300002b7;
        bram[71] = 32'h06400313;
        bram[72] = 32'h0062a023;
        bram[73] = 32'h300002b7;
        bram[74] = 32'h00428293;
        bram[75] = 32'h0002a023;
        bram[76] = 32'h300002b7;
        bram[77] = 32'h00828293;
        bram[78] = 32'h0002a403;
        bram[79] = 32'h300002b7;
        bram[80] = 32'h00428293;
        bram[81] = 32'h05f00313;
        bram[82] = 32'h0062a023;
        bram[83] = 32'h300002b7;
        bram[84] = 32'h00828293;
        bram[85] = 32'h0002a483;
        bram[86] = 32'h03300513;
        bram[87] = 32'heb1ff0ef;
        bram[88] = 32'h0084d863;
        bram[89] = 32'h05000513;
        bram[90] = 32'hea5ff0ef;
        bram[91] = 32'h00c0006f;
        bram[92] = 32'h04600513;
        bram[93] = 32'he99ff0ef;
        bram[94] = 32'h00a00513;
        bram[95] = 32'he91ff0ef;
        bram[96] = 32'h002002b7;
        bram[97] = 32'hfff28293;
        bram[98] = 32'hfe029ee3;
        bram[99] = 32'he91ff06f;
    end
endmodule

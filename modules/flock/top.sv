// FLOCK compositor test: RIME-I + FLOCK
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[16] = 32'h00a00293;
        bram[17] = 32'h00541863;
        bram[18] = 32'h05000513;
        bram[19] = 32'hfc1ff0ef;
        bram[20] = 32'h00c0006f;
        bram[21] = 32'h04600513;
        bram[22] = 32'hfb5ff0ef;
        bram[23] = 32'h300002b7;
        bram[24] = 32'h00828293;
        bram[25] = 32'h00100313;
        bram[26] = 32'h0062a023;
        bram[27] = 32'h00000913;
        bram[28] = 32'h00500993;
        bram[29] = 32'h01395c63;
        bram[30] = 32'h300002b7;
        bram[31] = 32'h00100313;
        bram[32] = 32'h0062a023;
        bram[33] = 32'h00190913;
        bram[34] = 32'hfedff06f;
        bram[35] = 32'h300002b7;
        bram[36] = 32'h01028293;
        bram[37] = 32'h0002a403;
        bram[38] = 32'h03200513;
        bram[39] = 32'hf71ff0ef;
        bram[40] = 32'h00a00293;
        bram[41] = 32'h00540863;
        bram[42] = 32'h05000513;
        bram[43] = 32'hf61ff0ef;
        bram[44] = 32'h00c0006f;
        bram[45] = 32'h04600513;
        bram[46] = 32'hf55ff0ef;
        bram[47] = 32'h300002b7;
        bram[48] = 32'h00428293;
        bram[49] = 32'h0002a403;
        bram[50] = 32'h03300513;
        bram[51] = 32'hf41ff0ef;
        bram[52] = 32'h00500293;
        bram[53] = 32'h00541863;
        bram[54] = 32'h05000513;
        bram[55] = 32'hf31ff0ef;
        bram[56] = 32'h00c0006f;
        bram[57] = 32'h04600513;
        bram[58] = 32'hf25ff0ef;
        bram[59] = 32'h00a00513;
        bram[60] = 32'hf1dff0ef;
        bram[61] = 32'h002002b7;
        bram[62] = 32'hfff28293;
        bram[63] = 32'hfe029ee3;
        bram[64] = 32'hf1dff06f;
    end
endmodule

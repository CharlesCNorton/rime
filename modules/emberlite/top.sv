// EMBERLITE compositor test: RIME-I + EMBERLITE
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    emberlite MOD(.clk(sys_clk),.rst(rst),
    ...
    initial begin
        ...
        bram[8] = 32'h0002a403;
        bram[9] = 32'h03100513;
        bram[10] = 32'hfe5ff0ef;
        bram[11] = 32'h00040863;
        bram[12] = 32'h05000513;
        bram[13] = 32'hfd9ff0ef;
        bram[14] = 32'h00c0006f;
        bram[15] = 32'h04600513;
        bram[16] = 32'hfcdff0ef;
        bram[17] = 32'h300002b7;
        bram[18] = 32'h0002a403;
        bram[19] = 32'h0002a483;
        bram[20] = 32'h03200513;
        bram[21] = 32'hfb9ff0ef;
        bram[22] = 32'h00940863;
        ...
        bram[29] = 32'h00c28293;
        bram[30] = 32'h0002a403;
        bram[31] = 32'h300002b7;
        bram[32] = 32'h0002a303;
        bram[33] = 32'h0002a303;
        bram[34] = 32'h0002a303;
        bram[35] = 32'h0002a303;
        bram[36] = 32'h0002a303;
        bram[37] = 32'h300002b7;
        bram[38] = 32'h00c28293;
        bram[39] = 32'h0002a483;
        bram[40] = 32'h40848933;
        bram[41] = 32'h03300513;
        bram[42] = 32'hf65ff0ef;
        bram[43] = 32'h00500293;
        bram[44] = 32'h00591863;
        bram[45] = 32'h05000513;
        bram[46] = 32'hf55ff0ef;
        bram[47] = 32'h00c0006f;
        bram[48] = 32'h04600513;
        bram[49] = 32'hf49ff0ef;
        bram[50] = 32'h00a00513;
        bram[51] = 32'hf41ff0ef;
        bram[52] = 32'h002002b7;
        bram[53] = 32'hfff28293;
        bram[54] = 32'hfe029ee3;
        bram[55] = 32'hf41ff06f;
    end
endmodule

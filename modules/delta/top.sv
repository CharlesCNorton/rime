// DELTA compositor test: RIME-I + DELTA
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[12] = 32'h04200313;
        bram[13] = 32'h0062a023;
        bram[14] = 32'h300002b7;
        bram[15] = 32'h00428293;
        bram[16] = 32'h04200313;
        bram[17] = 32'h0062a023;
        bram[18] = 32'h300002b7;
        bram[19] = 32'h00828293;
        bram[20] = 32'h0002a403;
        bram[21] = 32'h300002b7;
        bram[22] = 32'h01828293;
        bram[23] = 32'h0002a483;
        bram[24] = 32'h03100513;
        bram[25] = 32'hfa9ff0ef;
        bram[26] = 32'h00041c63;
        bram[27] = 32'h00100293;
        bram[28] = 32'h00549863;
        bram[29] = 32'h05000513;
        bram[30] = 32'hf95ff0ef;
        bram[31] = 32'h00c0006f;
        bram[32] = 32'h04600513;
        bram[33] = 32'hf89ff0ef;
        bram[34] = 32'h300002b7;
        bram[35] = 32'h01428293;
        bram[36] = 32'h00100313;
        bram[37] = 32'h0062a023;
        bram[38] = 32'h300002b7;
        bram[39] = 32'h0ff00313;
        bram[40] = 32'h0062a023;
        bram[41] = 32'h300002b7;
        bram[42] = 32'h00428293;
        bram[43] = 32'h00000313;
        bram[44] = 32'h0062a023;
        bram[45] = 32'h300002b7;
        bram[46] = 32'h00828293;
        bram[47] = 32'h0002a403;
        bram[48] = 32'h300002b7;
        bram[49] = 32'h00c28293;
        bram[50] = 32'h0002a483;
        bram[51] = 32'h03200513;
        bram[52] = 32'hf3dff0ef;
        bram[53] = 32'h0ff00293;
        bram[54] = 32'h00541c63;
        bram[55] = 32'h00100293;
        bram[56] = 32'h00549863;
        bram[57] = 32'h05000513;
        bram[58] = 32'hf25ff0ef;
        bram[59] = 32'h00c0006f;
        bram[60] = 32'h04600513;
        bram[61] = 32'hf19ff0ef;
        bram[62] = 32'h300002b7;
        bram[63] = 32'h01428293;
        bram[64] = 32'h00100313;
        bram[65] = 32'h0062a023;
        bram[66] = 32'h300002b7;
        bram[67] = 32'h04100313;
        bram[68] = 32'h0062a023;
        bram[69] = 32'h300002b7;
        bram[70] = 32'h00428293;
        bram[71] = 32'h04100313;
        bram[72] = 32'h0062a023;
        bram[73] = 32'h300002b7;
        bram[74] = 32'h04200313;
        bram[75] = 32'h0062a023;
        bram[76] = 32'h300002b7;
        bram[77] = 32'h00428293;
        bram[78] = 32'h04200313;
        bram[79] = 32'h0062a023;
        bram[80] = 32'h300002b7;
        bram[81] = 32'h04300313;
        bram[82] = 32'h0062a023;
        bram[83] = 32'h300002b7;
        bram[84] = 32'h00428293;
        bram[85] = 32'h04300313;
        bram[86] = 32'h0062a023;
        bram[87] = 32'h300002b7;
        bram[88] = 32'h04400313;
        bram[89] = 32'h0062a023;
        bram[90] = 32'h300002b7;
        bram[91] = 32'h00428293;
        bram[92] = 32'h04400313;
        bram[93] = 32'h0062a023;
        bram[94] = 32'h300002b7;
        bram[95] = 32'h04500313;
        bram[96] = 32'h0062a023;
        bram[97] = 32'h300002b7;
        bram[98] = 32'h00428293;
        bram[99] = 32'h04500313;
        bram[100] = 32'h0062a023;
        bram[101] = 32'h300002b7;
        bram[102] = 32'h04600313;
        bram[103] = 32'h0062a023;
        bram[104] = 32'h300002b7;
        bram[105] = 32'h00428293;
        bram[106] = 32'h04600313;
        bram[107] = 32'h0062a023;
        bram[108] = 32'h300002b7;
        bram[109] = 32'h04700313;
        bram[110] = 32'h0062a023;
        bram[111] = 32'h300002b7;
        bram[112] = 32'h00428293;
        bram[113] = 32'h04700313;
        bram[114] = 32'h0062a023;
        bram[115] = 32'h300002b7;
        bram[116] = 32'h01000313;
        bram[117] = 32'h0062a023;
        bram[118] = 32'h300002b7;
        bram[119] = 32'h00428293;
        bram[120] = 32'h02000313;
        bram[121] = 32'h0062a023;
        bram[122] = 32'h300002b7;
        bram[123] = 32'h03000313;
        bram[124] = 32'h0062a023;
        bram[125] = 32'h300002b7;
        bram[126] = 32'h00428293;
        bram[127] = 32'h04000313;
        bram[128] = 32'h0062a023;
        bram[129] = 32'h300002b7;
        bram[130] = 32'h05000313;
        bram[131] = 32'h0062a023;
        bram[132] = 32'h300002b7;
        bram[133] = 32'h00428293;
        bram[134] = 32'h06000313;
        bram[135] = 32'h0062a023;
        bram[136] = 32'h300002b7;
        bram[137] = 32'h01028293;
        bram[138] = 32'h0002a403;
        bram[139] = 32'h300002b7;
        bram[140] = 32'h00c28293;
        bram[141] = 32'h0002a483;
        bram[142] = 32'h300002b7;
        bram[143] = 32'h01828293;
        bram[144] = 32'h0002a903;
        bram[145] = 32'h03300513;
        bram[146] = 32'hdc5ff0ef;
        bram[147] = 32'h00a00293;
        bram[148] = 32'h02541063;
        bram[149] = 32'h00300293;
        bram[150] = 32'h00549c63;
        bram[151] = 32'h00700293;
        bram[152] = 32'h00591863;
        bram[153] = 32'h05000513;
        bram[154] = 32'hda5ff0ef;
        bram[155] = 32'h00c0006f;
        bram[156] = 32'h04600513;
        bram[157] = 32'hd99ff0ef;
        bram[158] = 32'h00a00513;
        bram[159] = 32'hd91ff0ef;
        bram[160] = 32'h002002b7;
        bram[161] = 32'hfff28293;
        bram[162] = 32'hfe029ee3;
        bram[163] = 32'hd91ff06f;
    end
endmodule

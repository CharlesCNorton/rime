// RUNE compositor test: RIME-I + RUNE
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[12] = 32'h0002a023;
        bram[13] = 32'h300002b7;
        bram[14] = 32'h00828293;
        bram[15] = 32'h0002a403;
        bram[16] = 32'h03100513;
        bram[17] = 32'hfc9ff0ef;
        bram[18] = 32'h00041863;
        bram[19] = 32'h05000513;
        bram[20] = 32'hfbdff0ef;
        bram[21] = 32'h00c0006f;
        bram[22] = 32'h04600513;
        bram[23] = 32'hfb1ff0ef;
        bram[24] = 32'h300002b7;
        bram[25] = 32'h04100313;
        bram[26] = 32'h0062a023;
        bram[27] = 32'h300002b7;
        bram[28] = 32'h00428293;
        bram[29] = 32'h0002a023;
        bram[30] = 32'h300002b7;
        bram[31] = 32'h00828293;
        bram[32] = 32'h0002a403;
        bram[33] = 32'h03200513;
        bram[34] = 32'hf85ff0ef;
        bram[35] = 32'h01800293;
        bram[36] = 32'h00541863;
        ...
        bram[43] = 32'h05200313;
        bram[44] = 32'h0062a023;
        bram[45] = 32'h00000413;
        bram[46] = 32'h00000493;
        bram[47] = 32'h00800913;
        bram[48] = 32'h03245463;
        bram[49] = 32'h300002b7;
        bram[50] = 32'h00428293;
        bram[51] = 32'h0082a023;
        bram[52] = 32'h300002b7;
        bram[53] = 32'h00c28293;
        bram[54] = 32'h0002a303;
        bram[55] = 32'h006484b3;
        bram[56] = 32'h00140413;
        bram[57] = 32'hfddff06f;
        bram[58] = 32'h03300513;
        bram[59] = 32'hf21ff0ef;
        bram[60] = 32'h00a00293;
        bram[61] = 32'h0054c863;
        bram[62] = 32'h05000513;
        bram[63] = 32'hf11ff0ef;
        bram[64] = 32'h00c0006f;
        bram[65] = 32'h04600513;
        bram[66] = 32'hf05ff0ef;
        bram[67] = 32'h00a00513;
        bram[68] = 32'hefdff0ef;
        bram[69] = 32'h002002b7;
        bram[70] = 32'hfff28293;
        bram[71] = 32'hfe029ee3;
        bram[72] = 32'hefdff06f;
    end
endmodule

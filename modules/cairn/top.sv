// CAIRN compositor test: RIME-I + CAIRN
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[12] = 32'h00300313;
        bram[13] = 32'h0062a023;
        bram[14] = 32'h300002b7;
        bram[15] = 32'h00400313;
        bram[16] = 32'h0062a023;
        bram[17] = 32'h300002b7;
        bram[18] = 32'h00c28293;
        bram[19] = 32'h00400313;
        bram[20] = 32'h0062a023;
        bram[21] = 32'h300002b7;
        bram[22] = 32'h00428293;
        bram[23] = 32'h0002a403;
        bram[24] = 32'h03100513;
        bram[25] = 32'hfa9ff0ef;
        bram[26] = 32'h00700293;
        bram[27] = 32'h00541863;
        bram[28] = 32'h05000513;
        bram[29] = 32'hf99ff0ef;
        bram[30] = 32'h00c0006f;
        bram[31] = 32'h04600513;
        bram[32] = 32'hf8dff0ef;
        bram[33] = 32'h300002b7;
        bram[34] = 32'h01428293;
        bram[35] = 32'h00100313;
        bram[36] = 32'h0062a023;
        bram[37] = 32'h300002b7;
        bram[38] = 32'h00a00313;
        bram[39] = 32'h0062a023;
        bram[40] = 32'h300002b7;
        bram[41] = 32'h00300313;
        bram[42] = 32'h0062a023;
        bram[43] = 32'h300002b7;
        bram[44] = 32'h00c28293;
        bram[45] = 32'h00500313;
        bram[46] = 32'h0062a023;
        bram[47] = 32'h300002b7;
        bram[48] = 32'h00428293;
        bram[49] = 32'h0002a403;
        bram[50] = 32'h300002b7;
        bram[51] = 32'h01428293;
        bram[52] = 32'h00100313;
        bram[53] = 32'h0062a023;
        bram[54] = 32'h300002b7;
        bram[55] = 32'h00500313;
        bram[56] = 32'h0062a023;
        bram[57] = 32'h300002b7;
        bram[58] = 32'h00c28293;
        bram[59] = 32'h00100313;
        bram[60] = 32'h0062a023;
        bram[61] = 32'h300002b7;
        bram[62] = 32'h00c28293;
        bram[63] = 32'h00600313;
        bram[64] = 32'h0062a023;
        bram[65] = 32'h300002b7;
        bram[66] = 32'h00428293;
        bram[67] = 32'h0002a483;
        bram[68] = 32'h03200513;
        bram[69] = 32'hef9ff0ef;
        bram[70] = 32'h00700293;
        bram[71] = 32'h00541c63;
        bram[72] = 32'h01900293;
        bram[73] = 32'h00549863;
        bram[74] = 32'h05000513;
        bram[75] = 32'hee1ff0ef;
        bram[76] = 32'h00c0006f;
        bram[77] = 32'h04600513;
        bram[78] = 32'hed5ff0ef;
        bram[79] = 32'h300002b7;
        bram[80] = 32'h01428293;
        bram[81] = 32'h00100313;
        bram[82] = 32'h0062a023;
        bram[83] = 32'h300002b7;
        bram[84] = 32'h06400313;
        bram[85] = 32'h0062a023;
        bram[86] = 32'h300002b7;
        bram[87] = 32'h06400313;
        bram[88] = 32'h0062a023;
        bram[89] = 32'h300002b7;
        bram[90] = 32'h00c28293;
        bram[91] = 32'h00c00313;
        bram[92] = 32'h0062a023;
        bram[93] = 32'h300002b7;
        bram[94] = 32'h00428293;
        bram[95] = 32'h0002a403;
        bram[96] = 32'h300002b7;
        bram[97] = 32'h03200313;
        bram[98] = 32'h0062a023;
        bram[99] = 32'h300002b7;
        bram[100] = 32'h06400313;
        bram[101] = 32'h0062a023;
        bram[102] = 32'h300002b7;
        bram[103] = 32'h00c28293;
        bram[104] = 32'h00b00313;
        bram[105] = 32'h0062a023;
        bram[106] = 32'h300002b7;
        bram[107] = 32'h00428293;
        bram[108] = 32'h0002a483;
        bram[109] = 32'h300002b7;
        bram[110] = 32'h01028293;
        bram[111] = 32'h0002a903;
        bram[112] = 32'h03300513;
        bram[113] = 32'he49ff0ef;
        bram[114] = 32'h00100293;
        bram[115] = 32'h00541c63;
        bram[116] = 32'h00549a63;
        bram[117] = 32'h00091863;
        bram[118] = 32'h05000513;
        bram[119] = 32'he31ff0ef;
        bram[120] = 32'h00c0006f;
        bram[121] = 32'h04600513;
        bram[122] = 32'he25ff0ef;
        bram[123] = 32'h00a00513;
        bram[124] = 32'he1dff0ef;
        bram[125] = 32'h002002b7;
        bram[126] = 32'hfff28293;
        bram[127] = 32'hfe029ee3;
        bram[128] = 32'he1dff06f;
    end
endmodule

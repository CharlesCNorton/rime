// FORGE compositor test: RIME-I + FORGE
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[38] = 32'h0002a303;
        bram[39] = 32'hfe030ee3;
        bram[40] = 32'h300002b7;
        bram[41] = 32'h00c28293;
        bram[42] = 32'h0002a483;
        bram[43] = 32'h03200513;
        bram[44] = 32'hf5dff0ef;
        bram[45] = 32'h00940863;

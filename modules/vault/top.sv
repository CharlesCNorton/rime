// VAULT compositor test: RIME-I + VAULT
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[8] = 32'h0002a023;
        bram[9] = 32'h300002b7;
        bram[10] = 32'h01028293;
        bram[11] = 32'h0002a023;
        bram[12] = 32'h300002b7;
        bram[13] = 32'h00428293;
        bram[14] = 32'h0002a023;
        bram[15] = 32'h300002b7;
        bram[16] = 32'h01428293;
        ...
        bram[23] = 32'h0002a023;
        bram[24] = 32'h300002b7;
        bram[25] = 32'h00c28293;
        bram[26] = 32'h0002a023;
        bram[27] = 32'h300002b7;
        bram[28] = 32'h01c28293;
        bram[29] = 32'h0002a023;
        bram[30] = 32'h300002b7;
        bram[31] = 32'h02028293;
        bram[32] = 32'h00100313;
        bram[33] = 32'h0062a023;
        bram[34] = 32'h300002b7;
        bram[35] = 32'h02828293;
        bram[36] = 32'h0002a403;
        bram[37] = 32'h03100513;
        bram[38] = 32'hf75ff0ef;
        bram[39] = 32'h00040863;
        bram[40] = 32'h05000513;
        bram[41] = 32'hf69ff0ef;
        bram[42] = 32'h00c0006f;
        bram[43] = 32'h04600513;
        bram[44] = 32'hf5dff0ef;
        bram[45] = 32'h300002b7;
        bram[46] = 32'h01028293;
        bram[47] = 32'h00100313;
        bram[48] = 32'h0062a023;
        bram[49] = 32'h300002b7;
        bram[50] = 32'h02028293;
        bram[51] = 32'h00100313;
        bram[52] = 32'h0062a023;
        bram[53] = 32'h300002b7;
        bram[54] = 32'h02828293;
        bram[55] = 32'h0002a483;
        bram[56] = 32'h03200513;
        bram[57] = 32'hf29ff0ef;
        bram[58] = 32'h00940863;
        bram[59] = 32'h05000513;
        bram[60] = 32'hf1dff0ef;
        bram[61] = 32'h00c0006f;
        bram[62] = 32'h04600513;
        bram[63] = 32'hf11ff0ef;
        bram[64] = 32'h300002b7;
        bram[65] = 32'h01028293;
        bram[66] = 32'h0002a023;
        bram[67] = 32'h300002b7;
        bram[68] = 32'h02028293;
        bram[69] = 32'h00100313;
        bram[70] = 32'h0062a023;
        bram[71] = 32'h300002b7;
        bram[72] = 32'h02828293;
        bram[73] = 32'h0002a403;
        bram[74] = 32'h636364b7;
        bram[75] = 32'h36348493;
        bram[76] = 32'h03300513;
        bram[77] = 32'hed9ff0ef;
        bram[78] = 32'h00941863;
        bram[79] = 32'h05000513;
        bram[80] = 32'hecdff0ef;
        bram[81] = 32'h00c0006f;
        bram[82] = 32'h04600513;
        bram[83] = 32'hec1ff0ef;
        bram[84] = 32'h00a00513;
        bram[85] = 32'heb9ff0ef;
        bram[86] = 32'h002002b7;
        bram[87] = 32'hfff28293;
        bram[88] = 32'hfe029ee3;
        bram[89] = 32'heb9ff06f;
    end
endmodule

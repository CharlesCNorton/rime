// MOSS compositor test: RIME-I + MOSS
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[12] = 32'h00e00313;
        bram[13] = 32'h0062a623;
        bram[14] = 32'h300002b7;
        bram[15] = 32'h02028293;
        bram[16] = 32'h00100313;
        bram[17] = 32'h0062a023;
        bram[18] = 32'h300002b7;
        bram[19] = 32'h0082a403;
        bram[20] = 32'h00c2a483;
        bram[21] = 32'h0102a903;
        bram[22] = 32'h300002b7;
        bram[23] = 32'h02828293;
        bram[24] = 32'h0002a983;
        bram[25] = 32'h03100513;
        bram[26] = 32'hfa5ff0ef;
        bram[27] = 32'h00300293;
        bram[28] = 32'h00599863;
        ...
        bram[35] = 32'h02028293;
        bram[36] = 32'h00200313;
        bram[37] = 32'h0062a023;
        bram[38] = 32'h300002b7;
        bram[39] = 32'h00600313;
        bram[40] = 32'h0062a223;
        bram[41] = 32'h0062a423;
        ...
        bram[51] = 32'h0042a403;
        bram[52] = 32'h0082a483;
        bram[53] = 32'h03200513;
        bram[54] = 32'hf35ff0ef;
        bram[55] = 32'h00600293;
        bram[56] = 32'h00541a63;
        bram[57] = 32'h00549863;
        ...
        bram[64] = 32'h02828293;
        bram[65] = 32'h0002a403;
        bram[66] = 32'h03300513;
        bram[67] = 32'hf01ff0ef;
        bram[68] = 32'h00400293;
        bram[69] = 32'h00541863;
        bram[70] = 32'h05000513;
        bram[71] = 32'hef1ff0ef;
        bram[72] = 32'h00c0006f;
        bram[73] = 32'h04600513;
        bram[74] = 32'hee5ff0ef;
        bram[75] = 32'h00a00513;
        bram[76] = 32'heddff0ef;
        bram[77] = 32'h002002b7;
        bram[78] = 32'hfff28293;
        bram[79] = 32'hfe029ee3;
        bram[80] = 32'heddff06f;
    end
endmodule

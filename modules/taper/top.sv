// TAPER compositor test: RIME-I + TAPER
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[27] = 32'h06400313;
        bram[28] = 32'h0062a023;
        bram[29] = 32'h300002b7;
        bram[30] = 32'h00428293;
        bram[31] = 32'h06400313;
        bram[32] = 32'h0062a023;
        bram[33] = 32'h300002b7;
        bram[34] = 32'h00828293;
        bram[35] = 32'h0002a403;
        bram[36] = 32'h300002b7;
        bram[37] = 32'h00a00313;
        bram[38] = 32'h0062a023;
        bram[39] = 32'h300002b7;
        bram[40] = 32'h00428293;
        bram[41] = 32'h00500313;
        bram[42] = 32'h0062a023;
        bram[43] = 32'h300002b7;
        bram[44] = 32'h00c28293;
        bram[45] = 32'h0002a483;
        bram[46] = 32'h03200513;
        bram[47] = 32'hf51ff0ef;
        bram[48] = 32'h07f00293;
        bram[49] = 32'h00541c63;
        bram[50] = 32'h03200293;
        bram[51] = 32'h00549863;
        ...
        bram[58] = 32'hffb00313;
        bram[59] = 32'h0062a023;
        bram[60] = 32'h300002b7;
        bram[61] = 32'h00428293;
        bram[62] = 32'h00300313;
        bram[63] = 32'h0062a023;
        bram[64] = 32'h300002b7;
        bram[65] = 32'h01828293;
        bram[66] = 32'h0002a403;
        bram[67] = 32'h300002b7;
        bram[68] = 32'h01c28293;
        bram[69] = 32'h0002a483;
        bram[70] = 32'h300002b7;
        bram[71] = 32'hfd600313;
        bram[72] = 32'h0062a023;
        bram[73] = 32'h300002b7;
        bram[74] = 32'h01428293;
        bram[75] = 32'h0002a903;
        bram[76] = 32'h03300513;
        bram[77] = 32'hed9ff0ef;
        bram[78] = 32'hffb00293;
        bram[79] = 32'h02541063;
        bram[80] = 32'h00300293;
        bram[81] = 32'h00549c63;
        bram[82] = 32'h02a00293;
        bram[83] = 32'h00591863;

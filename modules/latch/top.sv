// LATCH compositor test: RIME-I + LATCH
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[12] = 32'h01428293;
        bram[13] = 32'h0002a023;
        bram[14] = 32'h0002a023;
        bram[15] = 32'h0002a023;
        bram[16] = 32'h300002b7;
        bram[17] = 32'h01828293;
        bram[18] = 32'h0002a403;
        bram[19] = 32'h03100513;
        bram[20] = 32'hfbdff0ef;
        bram[21] = 32'h00300293;
        bram[22] = 32'h00541863;
        bram[23] = 32'h05000513;
        ...
        bram[30] = 32'h00200313;
        bram[31] = 32'h0062a023;
        bram[32] = 32'h300002b7;
        bram[33] = 32'h00c28293;
        bram[34] = 32'h00100313;
        bram[35] = 32'h0062a023;
        bram[36] = 32'h300002b7;
        bram[37] = 32'h00828293;
        bram[38] = 32'h00100313;
        bram[39] = 32'h0062a023;
        bram[40] = 32'h7d000293;
        bram[41] = 32'hfff28293;
        bram[42] = 32'hfe029ee3;
        bram[43] = 32'h300002b7;
        bram[44] = 32'h00428293;
        bram[45] = 32'h0002a403;
        bram[46] = 32'h00147413;
        bram[47] = 32'h03200513;
        bram[48] = 32'hf4dff0ef;
        bram[49] = 32'h00040863;
        ...
        bram[56] = 32'h00828293;
        bram[57] = 32'h00400313;
        bram[58] = 32'h0062a023;
        bram[59] = 32'h300002b7;
        bram[60] = 32'h01428293;
        bram[61] = 32'h00000413;
        bram[62] = 32'h00a00493;
        bram[63] = 32'h00945863;
        bram[64] = 32'h0002a023;
        bram[65] = 32'h00140413;
        bram[66] = 32'hff5ff06f;
        bram[67] = 32'h300002b7;
        bram[68] = 32'h01828293;
        bram[69] = 32'h0002a403;
        bram[70] = 32'h300002b7;
        bram[71] = 32'h01c28293;
        bram[72] = 32'h0002a483;
        bram[73] = 32'h03300513;
        bram[74] = 32'hee5ff0ef;
        bram[75] = 32'h00a00293;
        bram[76] = 32'h00541863;
        bram[77] = 32'h05000513;
        bram[78] = 32'hed5ff0ef;
        bram[79] = 32'h00c0006f;
        bram[80] = 32'h04600513;
        bram[81] = 32'hec9ff0ef;
        bram[82] = 32'h00a00513;
        bram[83] = 32'hec1ff0ef;
        bram[84] = 32'h002002b7;
        bram[85] = 32'hfff28293;
        bram[86] = 32'hfe029ee3;
        bram[87] = 32'hec1ff06f;
    end
endmodule

// GRAIL compositor test: RIME-I + GRAIL
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[8] = 32'h0002a023;
        bram[9] = 32'h0002a223;
        bram[10] = 32'h0002a423;
        bram[11] = 32'h0002a623;
        bram[12] = 32'h0002a823;
        bram[13] = 32'h0002aa23;
        bram[14] = 32'h0002ac23;
        bram[15] = 32'h0002ae23;
        bram[16] = 32'h300002b7;
        bram[17] = 32'h02028293;
        bram[18] = 32'h00100313;
        bram[19] = 32'h0062a023;
        bram[20] = 32'h300002b7;
        bram[21] = 32'h02428293;
        bram[22] = 32'h0002a303;
        bram[23] = 32'hfe030ee3;
        bram[24] = 32'h300002b7;
        bram[25] = 32'h02828293;
        bram[26] = 32'h0002a403;
        bram[27] = 32'h03100513;
        bram[28] = 32'hf9dff0ef;
        bram[29] = 32'h00040863;
        bram[30] = 32'h05000513;
        bram[31] = 32'hf91ff0ef;
        bram[32] = 32'h00c0006f;
        bram[33] = 32'h04600513;
        bram[34] = 32'hf85ff0ef;
        bram[35] = 32'h300002b7;
        bram[36] = 32'h00100313;
        bram[37] = 32'h0062a023;
        bram[38] = 32'h300002b7;
        bram[39] = 32'h02028293;
        bram[40] = 32'h00100313;
        bram[41] = 32'h0062a023;
        bram[42] = 32'h300002b7;
        bram[43] = 32'h02428293;
        bram[44] = 32'h0002a303;
        bram[45] = 32'hfe030ee3;
        bram[46] = 32'h300002b7;
        bram[47] = 32'h02828293;
        bram[48] = 32'h0002a483;
        bram[49] = 32'h03200513;
        bram[50] = 32'hf45ff0ef;
        bram[51] = 32'h00940863;
        bram[52] = 32'h05000513;
        bram[53] = 32'hf39ff0ef;
        bram[54] = 32'h00c0006f;
        bram[55] = 32'h04600513;
        bram[56] = 32'hf2dff0ef;
        bram[57] = 32'h300002b7;
        bram[58] = 32'h00000313;
        bram[59] = 32'h0062a023;
        bram[60] = 32'h00100313;
        bram[61] = 32'h0062a223;
        bram[62] = 32'h00200313;
        bram[63] = 32'h0062a423;
        bram[64] = 32'h00300313;
        bram[65] = 32'h0062a623;
        bram[66] = 32'h00400313;
        bram[67] = 32'h0062a823;
        bram[68] = 32'h00500313;
        bram[69] = 32'h0062aa23;
        bram[70] = 32'h00600313;
        bram[71] = 32'h0062ac23;
        bram[72] = 32'h00700313;
        bram[73] = 32'h0062ae23;
        bram[74] = 32'h300002b7;
        bram[75] = 32'h02028293;
        bram[76] = 32'h00100313;
        bram[77] = 32'h0062a023;
        bram[78] = 32'h300002b7;
        bram[79] = 32'h02428293;
        bram[80] = 32'h0002a303;
        bram[81] = 32'hfe030ee3;
        bram[82] = 32'h300002b7;
        bram[83] = 32'h02828293;
        bram[84] = 32'h0002a403;
        bram[85] = 32'he51514b7;
        bram[86] = 32'h87348493;
        bram[87] = 32'h03300513;
        bram[88] = 32'headff0ef;
        bram[89] = 32'h00941863;
        bram[90] = 32'h05000513;
        bram[91] = 32'hea1ff0ef;
        bram[92] = 32'h00c0006f;
        bram[93] = 32'h04600513;
        bram[94] = 32'he95ff0ef;
        bram[95] = 32'h00a00513;
        bram[96] = 32'he8dff0ef;
        bram[97] = 32'h002002b7;
        bram[98] = 32'hfff28293;
        bram[99] = 32'hfe029ee3;
        bram[100] = 32'he8dff06f;
    end
endmodule

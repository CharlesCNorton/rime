// ORACLE compositor test: RIME-I + ORACLE
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    oracle MOD(.clk(sys_clk),.rst(rst),
    ...
    initial begin
        ...
        bram[8] = 32'h40028293;
        bram[9] = 32'h0002a023;
        bram[10] = 32'h3e800313;
        bram[11] = 32'h0062a223;
        bram[12] = 32'h300002b7;
        bram[13] = 32'h00000313;
        bram[14] = 32'h0062a023;
        bram[15] = 32'h300002b7;
        bram[16] = 32'h00428293;
        bram[17] = 32'h0002a403;
        bram[18] = 32'h03100513;
        bram[19] = 32'hfc1ff0ef;
        bram[20] = 32'h00041863;
        ...
        bram[27] = 32'h08000313;
        bram[28] = 32'h0062a023;
        bram[29] = 32'h300002b7;
        bram[30] = 32'h00428293;
        bram[31] = 32'h0002a403;
        bram[32] = 32'h03200513;
        bram[33] = 32'hf89ff0ef;
        bram[34] = 32'h1c200293;
        bram[35] = 32'h00544c63;
        bram[36] = 32'h22600293;
        bram[37] = 32'h00545863;
        ...
        bram[44] = 32'h41428293;
        bram[45] = 32'h00003337;
        bram[46] = 32'h03930313;
        bram[47] = 32'h0062a023;
        bram[48] = 32'h300002b7;
        bram[49] = 32'h50000313;
        bram[50] = 32'h0062a023;
        bram[51] = 32'h300002b7;
        bram[52] = 32'h00428293;
        bram[53] = 32'h0002a403;
        bram[54] = 32'h03300513;
        bram[55] = 32'hf31ff0ef;
        bram[56] = 32'h000032b7;
        bram[57] = 32'h03928293;
        bram[58] = 32'h00541863;
        bram[59] = 32'h05000513;
        bram[60] = 32'hf1dff0ef;
        bram[61] = 32'h00c0006f;
        bram[62] = 32'h04600513;
        bram[63] = 32'hf11ff0ef;
        bram[64] = 32'h00a00513;
        bram[65] = 32'hf09ff0ef;
        bram[66] = 32'h002002b7;
        bram[67] = 32'hfff28293;
        bram[68] = 32'hfe029ee3;
        bram[69] = 32'hf09ff06f;
    end
endmodule

// PARSE compositor test: RIME-I + PARSE
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[8] = 32'h10028293;
        bram[9] = 32'h00010337;
        bram[10] = 32'h80030313;
        bram[11] = 32'h0062a023;
        bram[12] = 32'h300002b7;
        bram[13] = 32'h00828293;
        bram[14] = 32'h00100313;
        bram[15] = 32'h0062a023;
        bram[16] = 32'h300002b7;
        bram[17] = 32'h00428293;
        bram[18] = 32'h0002a403;
        bram[19] = 32'h00147413;
        bram[20] = 32'h03100513;
        bram[21] = 32'hfb9ff0ef;
        bram[22] = 32'h00041863;
        bram[23] = 32'h04600513;
        bram[24] = 32'hfadff0ef;
        bram[25] = 32'h00c0006f;
        bram[26] = 32'h05000513;
        bram[27] = 32'hfa1ff0ef;
        bram[28] = 32'h300002b7;
        bram[29] = 32'h10028293;
        bram[30] = 32'h0000c337;
        bram[31] = 32'h94130313;
        bram[32] = 32'h0062a023;
        bram[33] = 32'h300002b7;
        bram[34] = 32'h10428293;
        bram[35] = 32'h24200313;
        bram[36] = 32'h0062a023;
        bram[37] = 32'h300002b7;
        bram[38] = 32'h10828293;
        bram[39] = 32'h00008337;
        bram[40] = 32'ha0030313;
        bram[41] = 32'h0062a023;
        bram[42] = 32'h300002b7;
        bram[43] = 32'h00828293;
        bram[44] = 32'h00100313;
        bram[45] = 32'h0062a023;
        bram[46] = 32'h300002b7;
        bram[47] = 32'h04100313;
        bram[48] = 32'h0062a023;
        bram[49] = 32'h300002b7;
        bram[50] = 32'h04200313;
        bram[51] = 32'h0062a023;
        bram[52] = 32'h300002b7;
        bram[53] = 32'h00428293;
        bram[54] = 32'h0002a403;
        bram[55] = 32'h00147413;
        bram[56] = 32'h03200513;
        bram[57] = 32'hf29ff0ef;
        bram[58] = 32'h00041863;
        bram[59] = 32'h04600513;
        bram[60] = 32'hf1dff0ef;
        bram[61] = 32'h00c0006f;
        bram[62] = 32'h05000513;
        bram[63] = 32'hf11ff0ef;
        bram[64] = 32'h300002b7;
        bram[65] = 32'h10028293;
        bram[66] = 32'h00008337;
        bram[67] = 32'h15230313;
        bram[68] = 32'h0062a023;
        bram[69] = 32'h300002b7;
        bram[70] = 32'h10428293;
        bram[71] = 32'h24900313;
        bram[72] = 32'h0062a023;
        bram[73] = 32'h300002b7;
        bram[74] = 32'h10828293;
        bram[75] = 32'h34d00313;
        bram[76] = 32'h0062a023;
        bram[77] = 32'h300002b7;
        bram[78] = 32'h10c28293;
        bram[79] = 32'h44500313;
        bram[80] = 32'h0062a023;
        bram[81] = 32'h300002b7;
        bram[82] = 32'h11028293;
        bram[83] = 32'h00008337;
        bram[84] = 32'hc0030313;
        bram[85] = 32'h0062a023;
        bram[86] = 32'h300002b7;
        bram[87] = 32'h00828293;
        bram[88] = 32'h00100313;
        bram[89] = 32'h0062a023;
        bram[90] = 32'h300002b7;
        bram[91] = 32'h05800313;
        bram[92] = 32'h0062a023;
        bram[93] = 32'h300002b7;
        bram[94] = 32'h05200313;
        bram[95] = 32'h0062a023;
        bram[96] = 32'h300002b7;
        bram[97] = 32'h04900313;
        bram[98] = 32'h0062a023;
        bram[99] = 32'h300002b7;
        bram[100] = 32'h04d00313;
        bram[101] = 32'h0062a023;
        bram[102] = 32'h300002b7;
        bram[103] = 32'h04500313;
        bram[104] = 32'h0062a023;
        bram[105] = 32'h300002b7;
        bram[106] = 32'h00428293;
        bram[107] = 32'h0002a403;
        bram[108] = 32'h00147413;
        bram[109] = 32'h03300513;
        bram[110] = 32'he55ff0ef;
        bram[111] = 32'h00041863;
        bram[112] = 32'h04600513;
        bram[113] = 32'he49ff0ef;
        bram[114] = 32'h00c0006f;
        bram[115] = 32'h05000513;
        bram[116] = 32'he3dff0ef;
        bram[117] = 32'h00a00513;
        bram[118] = 32'he35ff0ef;
        bram[119] = 32'h002002b7;
        bram[120] = 32'hfff28293;
        bram[121] = 32'hfe029ee3;
        bram[122] = 32'he35ff06f;
    end
endmodule

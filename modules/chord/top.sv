// CHORD compositor test: RIME-I + CHORD
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[12] = 32'h10000337;
        bram[13] = 32'h0062a023;
        bram[14] = 32'h300002b7;
        bram[15] = 32'h00428293;
        bram[16] = 32'h06400313;
        bram[17] = 32'h0062a023;
        bram[18] = 32'h300002b7;
        bram[19] = 32'h02428293;
        bram[20] = 32'h00100313;
        bram[21] = 32'h0062a023;
        bram[22] = 32'h06400293;
        bram[23] = 32'hfff28293;
        bram[24] = 32'hfe029ee3;
        bram[25] = 32'h300002b7;
        bram[26] = 32'h02028293;
        bram[27] = 32'h0002a403;
        bram[28] = 32'h03100513;
        bram[29] = 32'hf99ff0ef;
        bram[30] = 32'h00040c63;
        bram[31] = 32'h06400293;
        bram[32] = 32'h00540863;
        bram[33] = 32'h04600513;
        bram[34] = 32'hf85ff0ef;
        bram[35] = 32'h00c0006f;
        bram[36] = 32'h05000513;
        bram[37] = 32'hf79ff0ef;
        bram[38] = 32'h300002b7;
        bram[39] = 32'h00828293;
        bram[40] = 32'h08000337;
        bram[41] = 32'h0062a023;
        bram[42] = 32'h300002b7;
        bram[43] = 32'h00c28293;
        bram[44] = 32'h03200313;
        bram[45] = 32'h0062a023;
        bram[46] = 32'h06400293;
        bram[47] = 32'hfff28293;
        bram[48] = 32'hfe029ee3;
        bram[49] = 32'h00000493;
        bram[50] = 32'h00000913;
        bram[51] = 32'h01400993;
        bram[52] = 32'h03395463;
        bram[53] = 32'h300002b7;
        bram[54] = 32'h02028293;
        bram[55] = 32'h0002a303;
        bram[56] = 32'h00030863;
        bram[57] = 32'h06400293;
        bram[58] = 32'h00530463;
        bram[59] = 32'h00148493;
        bram[60] = 32'h00190913;
        bram[61] = 32'hfddff06f;
        bram[62] = 32'h03200513;
        bram[63] = 32'hf11ff0ef;
        bram[64] = 32'h00048863;
        bram[65] = 32'h05000513;
        bram[66] = 32'hf05ff0ef;
        bram[67] = 32'h00c0006f;
        bram[68] = 32'h04600513;
        bram[69] = 32'hef9ff0ef;
        bram[70] = 32'h300002b7;
        bram[71] = 32'h01028293;
        bram[72] = 32'h10000337;
        bram[73] = 32'h0062a023;
        bram[74] = 32'h300002b7;
        bram[75] = 32'h01428293;
        bram[76] = 32'h06400313;
        bram[77] = 32'h0062a023;
        bram[78] = 32'h300002b7;
        bram[79] = 32'h01828293;
        bram[80] = 32'h10000337;
        bram[81] = 32'h0062a023;
        bram[82] = 32'h300002b7;
        bram[83] = 32'h01c28293;
        bram[84] = 32'h06400313;
        bram[85] = 32'h0062a023;
        bram[86] = 32'h300002b7;
        bram[87] = 32'h00828293;
        bram[88] = 32'h10000337;
        bram[89] = 32'h0062a023;
        bram[90] = 32'h0c800293;
        bram[91] = 32'hfff28293;
        bram[92] = 32'hfe029ee3;
        bram[93] = 32'h00000413;
        bram[94] = 32'h00000913;
        bram[95] = 32'h01400993;
        bram[96] = 32'h03395063;
        bram[97] = 32'h300002b7;
        bram[98] = 32'h02028293;
        bram[99] = 32'h0002a303;
        bram[100] = 32'h00645463;
        bram[101] = 32'h00030413;
        bram[102] = 32'h00190913;
        bram[103] = 32'hfe5ff06f;
        bram[104] = 32'h03300513;
        bram[105] = 32'he69ff0ef;
        bram[106] = 32'h0c800293;
        bram[107] = 32'h00544863;
        bram[108] = 32'h05000513;
        bram[109] = 32'he59ff0ef;
        bram[110] = 32'h00c0006f;
        bram[111] = 32'h04600513;
        bram[112] = 32'he4dff0ef;
        bram[113] = 32'h00a00513;
        bram[114] = 32'he45ff0ef;
        bram[115] = 32'h002002b7;
        bram[116] = 32'hfff28293;
        bram[117] = 32'hfe029ee3;
        bram[118] = 32'he45ff06f;
    end
endmodule

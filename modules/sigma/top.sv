// SIGMA compositor test: RIME-I + SIGMA
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[27] = 32'h04100313;
        bram[28] = 32'h0062a023;
        bram[29] = 32'h300002b7;
        bram[30] = 32'h04200313;
        bram[31] = 32'h0062a023;
        bram[32] = 32'h300002b7;
        bram[33] = 32'h00428293;
        bram[34] = 32'h0002a403;
        bram[35] = 32'h0000c4b7;
        bram[36] = 32'h48348493;
        bram[37] = 32'h03200513;
        bram[38] = 32'hf75ff0ef;
        bram[39] = 32'h00941863;
        ...
        bram[50] = 32'h00000413;
        bram[51] = 32'h10000493;
        bram[52] = 32'h00945863;
        bram[53] = 32'h0082a023;
        bram[54] = 32'h00140413;
        bram[55] = 32'hff5ff06f;
        bram[56] = 32'h300002b7;
        bram[57] = 32'h00428293;
        bram[58] = 32'h0002a403;
        bram[59] = 32'h000054b7;
        bram[60] = 32'h50048493;
        bram[61] = 32'h300002b7;
        bram[62] = 32'h00c28293;
        bram[63] = 32'h0002a903;
        bram[64] = 32'h03300513;
        bram[65] = 32'hf09ff0ef;
        bram[66] = 32'h00941c63;
        bram[67] = 32'h10000293;
        bram[68] = 32'h00591863;
        bram[69] = 32'h05000513;
        bram[70] = 32'hef5ff0ef;
        bram[71] = 32'h00c0006f;
        bram[72] = 32'h04600513;
        bram[73] = 32'hee9ff0ef;
        bram[74] = 32'h00a00513;
        bram[75] = 32'hee1ff0ef;
        bram[76] = 32'h002002b7;
        bram[77] = 32'hfff28293;
        bram[78] = 32'hfe029ee3;
        bram[79] = 32'hee1ff06f;
    end
endmodule

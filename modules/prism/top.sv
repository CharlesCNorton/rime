// PRISM compositor test: RIME-I + PRISM
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[15] = 32'h01028293;
        bram[16] = 32'h0002a483;
        bram[17] = 32'h03100513;
        bram[18] = 32'hfc5ff0ef;
        bram[19] = 32'h0fa00293;
        bram[20] = 32'h00544a63;
        bram[21] = 32'h00049863;
        ...
        bram[28] = 32'h00ff0337;
        bram[29] = 32'h0062a023;
        bram[30] = 32'h300002b7;
        bram[31] = 32'h00428293;
        bram[32] = 32'h0002a403;
        bram[33] = 32'h300002b7;
        bram[34] = 32'h01028293;
        bram[35] = 32'h0002a483;
        bram[36] = 32'h03200513;
        bram[37] = 32'hf79ff0ef;
        bram[38] = 32'h04600293;
        bram[39] = 32'h02544063;
        bram[40] = 32'h05500293;
        bram[41] = 32'h00545c63;
        bram[42] = 32'h0ff00293;
        bram[43] = 32'h00549863;
        bram[44] = 32'h05000513;
        bram[45] = 32'hf59ff0ef;
        bram[46] = 32'h00c0006f;
        bram[47] = 32'h04600513;
        bram[48] = 32'hf4dff0ef;
        bram[49] = 32'h300002b7;
        bram[50] = 32'h00808337;
        bram[51] = 32'h08030313;
        bram[52] = 32'h0062a023;
        bram[53] = 32'h300002b7;
        bram[54] = 32'h00428293;
        bram[55] = 32'h0002a403;
        bram[56] = 32'h300002b7;
        bram[57] = 32'h01428293;
        bram[58] = 32'h0002a483;
        bram[59] = 32'h03300513;
        bram[60] = 32'hf1dff0ef;
        bram[61] = 32'h07c00293;
        bram[62] = 32'h02544263;
        bram[63] = 32'h08400293;
        bram[64] = 32'h00545e63;
        bram[65] = 32'h007f82b7;
        bram[66] = 32'hf7f28293;
        bram[67] = 32'h00549863;

// PACK compositor test: RIME-I + PACK
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[12] = 32'h04100313;
        bram[13] = 32'h0062a023;
        bram[14] = 32'h04200313;
        bram[15] = 32'h0062a023;
        bram[16] = 32'h04300313;
        bram[17] = 32'h0062a023;
        bram[18] = 32'h04400313;
        bram[19] = 32'h0062a023;
        bram[20] = 32'h04500313;
        bram[21] = 32'h0062a023;
        bram[22] = 32'h300002b7;
        bram[23] = 32'h00828293;
        bram[24] = 32'h00100313;
        bram[25] = 32'h0062a023;
        bram[26] = 32'h300002b7;
        bram[27] = 32'h00c28293;
        bram[28] = 32'h0002a403;
        bram[29] = 32'h03f47413;
        bram[30] = 32'h03100513;
        bram[31] = 32'hf91ff0ef;
        bram[32] = 32'h00400293;
        bram[33] = 32'h00544863;
        bram[34] = 32'h05000513;
        bram[35] = 32'hf81ff0ef;
        bram[36] = 32'h00c0006f;
        bram[37] = 32'h04600513;
        bram[38] = 32'hf75ff0ef;
        bram[39] = 32'h300002b7;
        bram[40] = 32'h00828293;
        bram[41] = 32'h00200313;
        bram[42] = 32'h0062a023;
        bram[43] = 32'h300002b7;
        bram[44] = 32'h04100313;
        bram[45] = 32'h0062a023;
        bram[46] = 32'h0062a023;
        bram[47] = 32'h0062a023;
        bram[48] = 32'h0062a023;
        bram[49] = 32'h300002b7;
        bram[50] = 32'h00828293;
        bram[51] = 32'h00100313;
        bram[52] = 32'h0062a023;
        bram[53] = 32'h300002b7;
        bram[54] = 32'h00428293;
        bram[55] = 32'h0002a403;
        bram[56] = 32'h03200513;
        bram[57] = 32'hf29ff0ef;
        bram[58] = 32'h000102b7;
        bram[59] = 32'hfff28293;
        bram[60] = 32'h00540863;
        bram[61] = 32'h05000513;
        bram[62] = 32'hf15ff0ef;
        bram[63] = 32'h00c0006f;
        bram[64] = 32'h04600513;
        bram[65] = 32'hf09ff0ef;
        bram[66] = 32'h300002b7;
        bram[67] = 32'h00828293;
        bram[68] = 32'h00200313;
        bram[69] = 32'h0062a023;
        bram[70] = 32'h300002b7;
        bram[71] = 32'h04200313;
        bram[72] = 32'h00000913;
        bram[73] = 32'h00a00993;
        bram[74] = 32'h01395863;
        bram[75] = 32'h0062a023;
        bram[76] = 32'h00190913;
        bram[77] = 32'hff5ff06f;
        bram[78] = 32'h04300313;
        bram[79] = 32'h0062a023;
        bram[80] = 32'h04400313;
        bram[81] = 32'h0062a023;
        bram[82] = 32'h300002b7;
        bram[83] = 32'h00828293;
        bram[84] = 32'h00100313;
        bram[85] = 32'h0062a023;
        bram[86] = 32'h300002b7;
        bram[87] = 32'h00c28293;
        bram[88] = 32'h0002a403;
        bram[89] = 32'h03f47413;
        bram[90] = 32'h03300513;
        bram[91] = 32'hea1ff0ef;
        bram[92] = 32'h00041863;
        bram[93] = 32'h04600513;
        bram[94] = 32'he95ff0ef;
        bram[95] = 32'h00c0006f;
        bram[96] = 32'h05000513;
        bram[97] = 32'he89ff0ef;
        bram[98] = 32'h00a00513;
        bram[99] = 32'he81ff0ef;
        bram[100] = 32'h002002b7;
        bram[101] = 32'hfff28293;
        bram[102] = 32'hfe029ee3;
        bram[103] = 32'he81ff06f;
    end
endmodule

// EPOCH compositor test: RIME-I + EPOCH
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[13] = 32'h3e800293;
        bram[14] = 32'hfff28293;
        bram[15] = 32'hfe029ee3;
        bram[16] = 32'h300002b7;
        bram[17] = 32'h01428293;
        bram[18] = 32'h0002a403;
        bram[19] = 32'h03100513;
        bram[20] = 32'hfbdff0ef;
        bram[21] = 32'h00040863;
        bram[22] = 32'h05000513;
        bram[23] = 32'hfb1ff0ef;
        bram[24] = 32'h00c0006f;
        bram[25] = 32'h04600513;
        bram[26] = 32'hfa5ff0ef;
        bram[27] = 32'h300002b7;
        bram[28] = 32'h02a00313;
        bram[29] = 32'h0062a023;
        bram[30] = 32'h300002b7;
        bram[31] = 32'h00428293;
        bram[32] = 32'h01e00313;
        bram[33] = 32'h0062a023;
        bram[34] = 32'h300002b7;
        bram[35] = 32'h00828293;
        bram[36] = 32'h00f00313;
        bram[37] = 32'h0062a023;
        bram[38] = 32'h300002b7;
        bram[39] = 32'h00c28293;
        bram[40] = 32'h06400313;
        bram[41] = 32'h0062a023;
        bram[42] = 32'h300002b7;
        bram[43] = 32'h0002a403;
        bram[44] = 32'h300002b7;
        bram[45] = 32'h00428293;
        bram[46] = 32'h0002a483;
        bram[47] = 32'h300002b7;
        bram[48] = 32'h00828293;
        bram[49] = 32'h0002a903;
        bram[50] = 32'h300002b7;
        bram[51] = 32'h00c28293;
        bram[52] = 32'h0002a983;
        bram[53] = 32'h03200513;
        bram[54] = 32'hf35ff0ef;
        bram[55] = 32'h02a00293;
        bram[56] = 32'h02544463;
        bram[57] = 32'h01e00293;
        bram[58] = 32'h02549063;
        bram[59] = 32'h00f00293;
        bram[60] = 32'h00591c63;
        bram[61] = 32'h06400293;
        bram[62] = 32'h00599863;
        ...
        bram[69] = 32'h01428293;
        bram[70] = 32'h0002a403;
        bram[71] = 32'h1f400293;
        bram[72] = 32'hfff28293;
        bram[73] = 32'hfe029ee3;
        bram[74] = 32'h300002b7;
        bram[75] = 32'h01428293;
        bram[76] = 32'h0002a483;
        bram[77] = 32'h03300513;
        bram[78] = 32'hed5ff0ef;
        bram[79] = 32'h00945863;
        bram[80] = 32'h05000513;
        bram[81] = 32'hec9ff0ef;
        bram[82] = 32'h00c0006f;
        bram[83] = 32'h04600513;
        bram[84] = 32'hebdff0ef;
        bram[85] = 32'h00a00513;
        bram[86] = 32'heb5ff0ef;
        bram[87] = 32'h002002b7;
        bram[88] = 32'hfff28293;
        bram[89] = 32'hfe029ee3;
        bram[90] = 32'heb5ff06f;
    end
endmodule

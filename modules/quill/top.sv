// QUILL compositor test: RIME-I + QUILL
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[41] = 32'h05800313;
        bram[42] = 32'h0062a023;
        bram[43] = 32'h300002b7;
        bram[44] = 32'h05900313;
        bram[45] = 32'h0062a023;
        bram[46] = 32'h300002b7;
        bram[47] = 32'h00428293;
        bram[48] = 32'h00000313;
        bram[49] = 32'h0062a023;
        bram[50] = 32'h300002b7;
        bram[51] = 32'h01028293;
        bram[52] = 32'h0002a403;
        bram[53] = 32'h03200513;
        bram[54] = 32'hf35ff0ef;
        bram[55] = 32'h00300293;
        bram[56] = 32'h00541863;
        ...
        bram[79] = 32'h00a00513;
        bram[80] = 32'hecdff0ef;
        bram[81] = 32'h002002b7;
        bram[82] = 32'hfff28293;
        bram[83] = 32'hfe029ee3;
        bram[84] = 32'hecdff06f;
    end
endmodule

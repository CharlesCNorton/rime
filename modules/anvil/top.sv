// ANVIL compositor test: RIME-I + ANVIL
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[12] = 32'h00428293;
        bram[13] = 32'h0002a403;
        bram[14] = 32'h03100513;
        bram[15] = 32'hfd1ff0ef;
        bram[16] = 32'h00041863;
        bram[17] = 32'h05000513;
        bram[18] = 32'hfc5ff0ef;
        bram[19] = 32'h00c0006f;
        bram[20] = 32'h04600513;
        ...
        bram[27] = 32'h05200313;
        bram[28] = 32'h0062a023;
        bram[29] = 32'h04900313;
        bram[30] = 32'h0062a023;
        bram[31] = 32'h04d00313;
        bram[32] = 32'h0062a023;
        bram[33] = 32'h04500313;
        bram[34] = 32'h0062a023;
        bram[35] = 32'h300002b7;
        bram[36] = 32'h00428293;
        bram[37] = 32'h0002a403;
        bram[38] = 32'h7c6a34b7;
        bram[39] = 32'ha2d48493;
        bram[40] = 32'h03200513;
        bram[41] = 32'hf69ff0ef;
        bram[42] = 32'h00941863;
        bram[43] = 32'h05000513;
        bram[44] = 32'hf5dff0ef;
        bram[45] = 32'h00c0006f;
        bram[46] = 32'h04600513;
        bram[47] = 32'hf51ff0ef;
        bram[48] = 32'h300002b7;
        bram[49] = 32'h00828293;
        bram[50] = 32'h00100313;
        bram[51] = 32'h0062a023;
        bram[52] = 32'h300002b7;
        bram[53] = 32'h00000413;
        bram[54] = 32'h10000493;
        bram[55] = 32'h00945863;
        bram[56] = 32'h0082a023;
        bram[57] = 32'h00140413;
        bram[58] = 32'hff5ff06f;
        bram[59] = 32'h300002b7;
        bram[60] = 32'h00428293;
        bram[61] = 32'h0002a403;
        bram[62] = 32'h290594b7;
        bram[63] = 32'hc7348493;
        bram[64] = 32'h300002b7;
        bram[65] = 32'h01028293;
        bram[66] = 32'h0002a903;
        bram[67] = 32'h03300513;
        bram[68] = 32'hefdff0ef;
        bram[69] = 32'h00941c63;
        bram[70] = 32'h10000293;
        bram[71] = 32'h00591863;
        bram[72] = 32'h05000513;
        bram[73] = 32'hee9ff0ef;
        bram[74] = 32'h00c0006f;
        bram[75] = 32'h04600513;
        bram[76] = 32'heddff0ef;
        bram[77] = 32'h00a00513;
        bram[78] = 32'hed5ff0ef;
        bram[79] = 32'h002002b7;
        bram[80] = 32'hfff28293;
        bram[81] = 32'hfe029ee3;
        bram[82] = 32'hed5ff06f;
    end
endmodule

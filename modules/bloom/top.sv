// BLOOM compositor test: RIME-I + BLOOM
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[14] = 32'h01428293;
        bram[15] = 32'h0002a483;
        bram[16] = 32'h03100513;
        bram[17] = 32'hfc9ff0ef;
        bram[18] = 32'h02000293;
        bram[19] = 32'h00541a63;
        bram[20] = 32'h00049863;
        ...
        bram[27] = 32'h80000337;
        bram[28] = 32'h00130313;
        bram[29] = 32'h0062a023;
        bram[30] = 32'h300002b7;
        bram[31] = 32'h00428293;
        bram[32] = 32'h0002a403;
        bram[33] = 32'h300002b7;
        bram[34] = 32'h00828293;
        bram[35] = 32'h0002a483;
        bram[36] = 32'h300002b7;
        bram[37] = 32'h00c28293;
        bram[38] = 32'h0002a903;
        bram[39] = 32'h03200513;
        bram[40] = 32'hf6dff0ef;
        bram[41] = 32'h00200293;
        bram[42] = 32'h00541c63;
        bram[43] = 32'h00049a63;
        bram[44] = 32'h00091863;
        ...
        bram[51] = 32'h12345337;
        bram[52] = 32'h67830313;
        bram[53] = 32'h0062a023;
        bram[54] = 32'h300002b7;
        bram[55] = 32'h00428293;
        bram[56] = 32'h0002a403;
        bram[57] = 32'h300002b7;
        bram[58] = 32'h01028293;
        bram[59] = 32'h0002a483;
        bram[60] = 32'h03300513;
        bram[61] = 32'hf19ff0ef;
        bram[62] = 32'h00d00293;
        bram[63] = 32'h00541e63;
        bram[64] = 32'h1e6a32b7;
        bram[65] = 32'hc4828293;
        bram[66] = 32'h00549863;
        bram[67] = 32'h05000513;
        bram[68] = 32'hefdff0ef;
        bram[69] = 32'h00c0006f;
        bram[70] = 32'h04600513;
        bram[71] = 32'hef1ff0ef;
        bram[72] = 32'h00a00513;
        bram[73] = 32'hee9ff0ef;
        bram[74] = 32'h002002b7;
        bram[75] = 32'hfff28293;
        bram[76] = 32'hfe029ee3;
        bram[77] = 32'hee9ff06f;
    end
endmodule

// MORTAR compositor test: RIME-I + MORTAR
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    mortar MOD(.clk(sys_clk),.rst(rst),
    ...
    initial begin
        ...
        bram[11] = 32'h00428293;
        bram[12] = 32'h00000313;
        bram[13] = 32'h0062a023;
        bram[14] = 32'h300002b7;
        bram[15] = 32'h00828293;
        bram[16] = 32'h00000313;
        bram[17] = 32'h0062a023;
        bram[18] = 32'h300002b7;
        bram[19] = 32'h00c28293;
        bram[20] = 32'h00100313;
        bram[21] = 32'h0062a023;
        bram[22] = 32'h300002b7;
        bram[23] = 32'h01028293;
        bram[24] = 32'h00300313;
        bram[25] = 32'h0062a023;
        bram[26] = 32'h300002b7;
        bram[27] = 32'h01428293;
        bram[28] = 32'h00400313;
        bram[29] = 32'h0062a023;
        bram[30] = 32'h300002b7;
        bram[31] = 32'h01828293;
        bram[32] = 32'h00500313;
        bram[33] = 32'h0062a023;
        bram[34] = 32'h300002b7;
        bram[35] = 32'h01c28293;
        bram[36] = 32'h00600313;
        bram[37] = 32'h0062a023;
        bram[38] = 32'h300002b7;
        bram[39] = 32'h02028293;
        bram[40] = 32'h0002a403;
        bram[41] = 32'h0042a483;
        bram[42] = 32'h03100513;
        bram[43] = 32'hf61ff0ef;
        bram[44] = 32'h00300293;
        bram[45] = 32'h00541c63;
        bram[46] = 32'h00400293;
        bram[47] = 32'h00549863;
        bram[48] = 32'h05000513;
        bram[49] = 32'hf49ff0ef;
        bram[50] = 32'h00c0006f;
        bram[51] = 32'h04600513;
        bram[52] = 32'hf3dff0ef;
        bram[53] = 32'h300002b7;
        bram[54] = 32'h00200313;
        bram[55] = 32'h0062a023;
        bram[56] = 32'h300002b7;
        bram[57] = 32'h00428293;
        bram[58] = 32'h00000313;
        bram[59] = 32'h0062a023;
        bram[60] = 32'h300002b7;
        bram[61] = 32'h00828293;
        bram[62] = 32'h00000313;
        bram[63] = 32'h0062a023;
        bram[64] = 32'h300002b7;
        bram[65] = 32'h00c28293;
        bram[66] = 32'h00200313;
        bram[67] = 32'h0062a023;
        bram[68] = 32'h300002b7;
        bram[69] = 32'h01028293;
        bram[70] = 32'h00300313;
        bram[71] = 32'h0062a023;
        bram[72] = 32'h300002b7;
        bram[73] = 32'h01428293;
        bram[74] = 32'h00400313;
        bram[75] = 32'h0062a023;
        bram[76] = 32'h300002b7;
        bram[77] = 32'h01828293;
        bram[78] = 32'h00500313;
        bram[79] = 32'h0062a023;
        bram[80] = 32'h300002b7;
        bram[81] = 32'h01c28293;
        bram[82] = 32'h00600313;
        bram[83] = 32'h0062a023;
        bram[84] = 32'h300002b7;
        bram[85] = 32'h02028293;
        bram[86] = 32'h0002a403;
        bram[87] = 32'h0042a483;
        bram[88] = 32'h03200513;
        bram[89] = 32'hea9ff0ef;
        bram[90] = 32'h00600293;
        bram[91] = 32'h00541c63;
        bram[92] = 32'h00800293;
        bram[93] = 32'h00549863;
        bram[94] = 32'h05000513;
        bram[95] = 32'he91ff0ef;
        bram[96] = 32'h00c0006f;
        bram[97] = 32'h04600513;
        bram[98] = 32'he85ff0ef;
        bram[99] = 32'h300002b7;
        bram[100] = 32'h00100313;
        bram[101] = 32'h0062a023;
        bram[102] = 32'h300002b7;
        bram[103] = 32'h00428293;
        bram[104] = 32'h00200313;
        bram[105] = 32'h0062a023;
        bram[106] = 32'h300002b7;
        bram[107] = 32'h00828293;
        bram[108] = 32'h00300313;
        bram[109] = 32'h0062a023;
        bram[110] = 32'h300002b7;
        bram[111] = 32'h00c28293;
        bram[112] = 32'h00400313;
        bram[113] = 32'h0062a023;
        bram[114] = 32'h300002b7;
        bram[115] = 32'h01028293;
        bram[116] = 32'h00500313;
        bram[117] = 32'h0062a023;
        bram[118] = 32'h300002b7;
        bram[119] = 32'h01428293;
        bram[120] = 32'h00600313;
        bram[121] = 32'h0062a023;
        bram[122] = 32'h300002b7;
        bram[123] = 32'h01828293;
        bram[124] = 32'h00700313;
        bram[125] = 32'h0062a023;
        bram[126] = 32'h300002b7;
        bram[127] = 32'h01c28293;
        bram[128] = 32'h00800313;
        bram[129] = 32'h0062a023;
        bram[130] = 32'h300002b7;
        bram[131] = 32'h02028293;
        bram[132] = 32'h0002a403;
        bram[133] = 32'h0042a483;
        bram[134] = 32'h03300513;
        bram[135] = 32'hdf1ff0ef;
        bram[136] = 32'h01300293;
        bram[137] = 32'h00541c63;
        bram[138] = 32'h01600293;
        bram[139] = 32'h00549863;
        bram[140] = 32'h05000513;
        bram[141] = 32'hdd9ff0ef;
        bram[142] = 32'h00c0006f;
        bram[143] = 32'h04600513;
        bram[144] = 32'hdcdff0ef;
        bram[145] = 32'h00a00513;
        bram[146] = 32'hdc5ff0ef;
        bram[147] = 32'h002002b7;
        bram[148] = 32'hfff28293;
        bram[149] = 32'hfe029ee3;
        bram[150] = 32'hdc5ff06f;
    end
endmodule

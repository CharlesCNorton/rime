// TIDE compositor test: RIME-I + TIDE
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[14] = 32'h10000337;
        bram[15] = 32'h0062a023;
        bram[16] = 32'h300002b7;
        bram[17] = 32'h00428293;
        bram[18] = 32'h00100313;
        bram[19] = 32'h0062a023;
        bram[20] = 32'h06400293;
        bram[21] = 32'hfff28293;
        bram[22] = 32'hfe029ee3;
        bram[23] = 32'h300002b7;
        bram[24] = 32'h00828293;
        bram[25] = 32'h0002a403;
        bram[26] = 32'h03100513;
        bram[27] = 32'hfa1ff0ef;
        bram[28] = 32'h00040c63;
        bram[29] = 32'h0ff00293;
        bram[30] = 32'h00540863;
        bram[31] = 32'h04600513;
        bram[32] = 32'hf8dff0ef;
        bram[33] = 32'h00c0006f;
        bram[34] = 32'h05000513;
        bram[35] = 32'hf81ff0ef;
        bram[36] = 32'h300002b7;
        bram[37] = 32'h00428293;
        bram[38] = 32'h00200313;
        bram[39] = 32'h0062a023;
        bram[40] = 32'h300002b7;
        bram[41] = 32'h00c28293;
        bram[42] = 32'h0002a403;
        bram[43] = 32'h03200293;
        bram[44] = 32'hfff28293;
        bram[45] = 32'hfe029ee3;
        bram[46] = 32'h300002b7;
        bram[47] = 32'h00c28293;
        ...
        bram[58] = 32'h00428293;
        bram[59] = 32'h00300313;
        bram[60] = 32'h0062a023;
        bram[61] = 32'h300002b7;
        bram[62] = 32'h00828293;
        bram[63] = 32'h0002a403;
        bram[64] = 32'h06400293;
        bram[65] = 32'hfff28293;
        bram[66] = 32'hfe029ee3;
        bram[67] = 32'h300002b7;
        bram[68] = 32'h00828293;
        bram[69] = 32'h0002a483;
        bram[70] = 32'h03300513;
        bram[71] = 32'hef1ff0ef;
        bram[72] = 32'h00940863;

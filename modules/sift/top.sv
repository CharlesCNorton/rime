// SIFT compositor test: RIME-I + SIFT
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    sift MOD(.clk(sys_clk),.rst(rst),
        .reg_addr(mem_addr[11:0]),.reg_wdata(mem_wdata),
        .reg_wr(is_mod&&mem_valid&&!mem_ready&&mem_wstrb!=0),
        .reg_rd(is_mod&&mem_valid&&!mem_ready&&mem_wstrb==0),
    ...
    initial begin
        ...
        bram[12] = 32'h02a00313;
        bram[13] = 32'h0062a023;
        bram[14] = 32'h08900313;
        bram[15] = 32'h0062a023;
        bram[16] = 32'h3e700313;
        bram[17] = 32'h0062a023;
        bram[18] = 32'h300002b7;
        bram[19] = 32'h00428293;
        bram[20] = 32'h02a00313;
        bram[21] = 32'h0062a023;
        bram[22] = 32'h0002a403;
        bram[23] = 32'h08900313;
        bram[24] = 32'h0062a023;
        bram[25] = 32'h0002a483;
        bram[26] = 32'h3e700313;
        bram[27] = 32'h0062a023;
        bram[28] = 32'h0002a903;
        bram[29] = 32'h03100513;
        bram[30] = 32'hf95ff0ef;
        bram[31] = 32'h009472b3;
        bram[32] = 32'h0122f2b3;
        bram[33] = 32'h00029863;
        bram[34] = 32'h04600513;
        bram[35] = 32'hf81ff0ef;
        bram[36] = 32'h00c0006f;
        bram[37] = 32'h05000513;
        bram[38] = 32'hf75ff0ef;
        bram[39] = 32'h300002b7;
        bram[40] = 32'h00428293;
        bram[41] = 32'h00700313;
        bram[42] = 32'h0062a023;
        bram[43] = 32'h0002a403;
        bram[44] = 32'h00001337;
        bram[45] = 32'h80030313;
        bram[46] = 32'h0062a023;
        bram[47] = 32'h0002a483;
        bram[48] = 32'h00003337;
        bram[49] = 32'h03930313;
        bram[50] = 32'h0062a023;
        bram[51] = 32'h0002a903;
        bram[52] = 32'h009402b3;
        bram[53] = 32'h012282b3;
        bram[54] = 32'h03200513;
        bram[55] = 32'hf31ff0ef;
        bram[56] = 32'h00200313;
        bram[57] = 32'h0062d863;
        bram[58] = 32'h05000513;
        bram[59] = 32'hf21ff0ef;
        bram[60] = 32'h00c0006f;
        bram[61] = 32'h04600513;
        bram[62] = 32'hf15ff0ef;
        bram[63] = 32'h300002b7;
        bram[64] = 32'h00828293;
        bram[65] = 32'h00100313;
        bram[66] = 32'h0062a023;
        bram[67] = 32'h300002b7;
        bram[68] = 32'h3e800413;
        bram[69] = 32'h3fc00493;
        bram[70] = 32'h00945863;
        bram[71] = 32'h0082a023;
        bram[72] = 32'h00140413;
        bram[73] = 32'hff5ff06f;
        bram[74] = 32'h300002b7;
        bram[75] = 32'h00428293;
        bram[76] = 32'h3e800413;
        bram[77] = 32'h3fc00493;
        bram[78] = 32'h00000913;
        bram[79] = 32'h00945c63;
        bram[80] = 32'h0082a023;
        bram[81] = 32'h0002a303;
        bram[82] = 32'h00690933;
        bram[83] = 32'h00140413;
        bram[84] = 32'hfedff06f;
        bram[85] = 32'h7d000413;
        bram[86] = 32'h7e400493;
        bram[87] = 32'h00000993;
        bram[88] = 32'h00945c63;
        bram[89] = 32'h0082a023;
        bram[90] = 32'h0002a303;
        bram[91] = 32'h006989b3;
        bram[92] = 32'h00140413;
        bram[93] = 32'hfedff06f;
        bram[94] = 32'h03300513;
        bram[95] = 32'he91ff0ef;
        bram[96] = 32'h01400293;
        bram[97] = 32'h00591c63;
        bram[98] = 32'h00500293;
        bram[99] = 32'h0059d863;
        bram[100] = 32'h05000513;
        bram[101] = 32'he79ff0ef;
        bram[102] = 32'h00c0006f;
        bram[103] = 32'h04600513;
        bram[104] = 32'he6dff0ef;
        bram[105] = 32'h00a00513;
        bram[106] = 32'he65ff0ef;
        bram[107] = 32'h002002b7;
        bram[108] = 32'hfff28293;
        bram[109] = 32'hfe029ee3;
        bram[110] = 32'he65ff06f;
    end
endmodule

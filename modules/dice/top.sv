// DICE compositor test: RIME-I + DICE
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[8] = 32'h0082a023;
        bram[9] = 32'h300002b7;
        bram[10] = 32'h00428293;
        bram[11] = 32'h0092a023;
        bram[12] = 32'h300002b7;
        bram[13] = 32'h00c28293;
        bram[14] = 32'h00100313;
        bram[15] = 32'h0062a023;
        bram[16] = 32'h300002b7;
        bram[17] = 32'h01028293;
        bram[18] = 32'h0002a303;
        bram[19] = 32'hfe030ee3;
        bram[20] = 32'h300002b7;
        bram[21] = 32'h00828293;
        bram[22] = 32'h0002a903;
        bram[23] = 32'h300002b7;
        bram[24] = 32'h01428293;
        bram[25] = 32'h0002a983;
        bram[26] = 32'h00008067;
        bram[27] = 32'h08000413;
        bram[28] = 32'h08000493;
        bram[29] = 32'hfa9ff0ef;
        bram[30] = 32'h03100513;
        bram[31] = 32'hf91ff0ef;
        bram[32] = 32'h03000293;
        bram[33] = 32'h00594c63;
        bram[34] = 32'h05000293;
        bram[35] = 32'h00595863;
        bram[36] = 32'h05000513;
        bram[37] = 32'hf79ff0ef;
        bram[38] = 32'h00c0006f;
        bram[39] = 32'h04600513;
        bram[40] = 32'hf6dff0ef;
        bram[41] = 32'h04000413;
        bram[42] = 32'h0c000493;
        bram[43] = 32'hf71ff0ef;
        bram[44] = 32'h03200513;
        bram[45] = 32'hf59ff0ef;
        bram[46] = 32'h06c00293;
        bram[47] = 32'h0059cc63;
        bram[48] = 32'h09400293;
        bram[49] = 32'h0059d863;
        bram[50] = 32'h05000513;
        bram[51] = 32'hf41ff0ef;
        bram[52] = 32'h00c0006f;
        bram[53] = 32'h04600513;
        bram[54] = 32'hf35ff0ef;
        bram[55] = 32'h00000413;
        bram[56] = 32'h08000493;
        bram[57] = 32'hf39ff0ef;
        bram[58] = 32'h00000e13;
        bram[59] = 32'h00500293;
        bram[60] = 32'h00595463;
        bram[61] = 32'h0080006f;
        bram[62] = 32'h001e0e13;
        bram[63] = 32'h0ff00413;
        bram[64] = 32'h08000493;
        bram[65] = 32'hf19ff0ef;
        bram[66] = 32'h06c00293;
        bram[67] = 32'h00594863;
        bram[68] = 32'h09400293;
        bram[69] = 32'h00595463;
        bram[70] = 32'h0080006f;
        bram[71] = 32'h001e0e13;
        bram[72] = 32'h08000413;
        bram[73] = 32'h08000493;
        bram[74] = 32'hef5ff0ef;
        bram[75] = 32'h03000293;
        bram[76] = 32'h00594863;
        bram[77] = 32'h05000293;
        bram[78] = 32'h00595463;
        bram[79] = 32'h0080006f;
        bram[80] = 32'h001e0e13;
        bram[81] = 32'h03300513;
        bram[82] = 32'hec5ff0ef;
        bram[83] = 32'h000e1863;
        bram[84] = 32'h05000513;
        bram[85] = 32'heb9ff0ef;
        bram[86] = 32'h00c0006f;
        bram[87] = 32'h04600513;
        bram[88] = 32'headff0ef;
        bram[89] = 32'h00a00513;
        bram[90] = 32'hea5ff0ef;
        bram[91] = 32'h002002b7;
        bram[92] = 32'hfff28293;
        bram[93] = 32'hfe029ee3;
        bram[94] = 32'hef5ff06f;
    end
endmodule

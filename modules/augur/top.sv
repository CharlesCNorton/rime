// AUGUR compositor test: RIME-I + AUGUR
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[8] = 32'h01028293;
        bram[9] = 32'h00100313;
        bram[10] = 32'h00040863;
        bram[11] = 32'h0062a023;
        bram[12] = 32'hfff40413;
        bram[13] = 32'hff5ff06f;
        bram[14] = 32'h00008067;
        bram[15] = 32'h300002b7;
        bram[16] = 32'h01028293;
        bram[17] = 32'h00200313;
        bram[18] = 32'h0062a023;
        bram[19] = 32'h300002b7;
        bram[20] = 32'h02028293;
        bram[21] = 32'h0002a023;
        bram[22] = 32'h03200413;
        bram[23] = 32'hfc1ff0ef;
        bram[24] = 32'h300002b7;
        bram[25] = 32'h01c28293;
        bram[26] = 32'h0002a403;
        bram[27] = 32'h03100513;
        bram[28] = 32'hf9dff0ef;
        bram[29] = 32'h01400293;
        bram[30] = 32'h00545c63;
        bram[31] = 32'hfec00293;
        bram[32] = 32'h00544863;
        ...
        bram[39] = 32'h01028293;
        bram[40] = 32'h00200313;
        bram[41] = 32'h0062a023;
        bram[42] = 32'h300002b7;
        bram[43] = 32'h02028293;
        bram[44] = 32'h06400313;
        bram[45] = 32'h0062a023;
        bram[46] = 32'h06400413;
        bram[47] = 32'hf61ff0ef;
        bram[48] = 32'h300002b7;
        bram[49] = 32'h01c28293;
        bram[50] = 32'h0002a403;
        bram[51] = 32'h03200513;
        bram[52] = 32'hf3dff0ef;
        bram[53] = 32'h04600293;
        bram[54] = 32'h00544c63;
        bram[55] = 32'h08200293;
        bram[56] = 32'h00545863;
        ...
        bram[64] = 32'h0002a403;
        bram[65] = 32'h300002b7;
        bram[66] = 32'h01828293;
        bram[67] = 32'h0002a483;
        bram[68] = 32'h03300513;
        bram[69] = 32'hef9ff0ef;
        bram[70] = 32'h03200293;
        bram[71] = 32'h00544a63;
        bram[72] = 32'h00048863;
        bram[73] = 32'h05000513;
        bram[74] = 32'hee5ff0ef;
        bram[75] = 32'h00c0006f;
        bram[76] = 32'h04600513;
        bram[77] = 32'hed9ff0ef;
        bram[78] = 32'h00a00513;
        bram[79] = 32'hed1ff0ef;
        bram[80] = 32'h002002b7;
        bram[81] = 32'hfff28293;
        bram[82] = 32'hfe029ee3;
        bram[83] = 32'hef1ff06f;
    end
endmodule

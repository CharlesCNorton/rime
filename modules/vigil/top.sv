// VIGIL compositor test: RIME-I + VIGIL
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[12] = 32'h0002a403;
        bram[13] = 32'h300002b7;
        bram[14] = 32'h00828293;
        bram[15] = 32'h0082a023;
        bram[16] = 32'h300002b7;
        bram[17] = 32'h00c28293;
        bram[18] = 32'h0002a483;
        bram[19] = 32'h300002b7;
        bram[20] = 32'h01028293;
        bram[21] = 32'h0002a903;
        bram[22] = 32'h03100513;
        bram[23] = 32'hfb1ff0ef;
        bram[24] = 32'h00a00293;
        bram[25] = 32'h00549a63;
        bram[26] = 32'h00091863;
        bram[27] = 32'h05000513;
        bram[28] = 32'hf9dff0ef;
        bram[29] = 32'h00c0006f;
        bram[30] = 32'h04600513;
        bram[31] = 32'hf91ff0ef;
        bram[32] = 32'h00100393;
        bram[33] = 32'h00744333;
        bram[34] = 32'h300002b7;
        bram[35] = 32'h00828293;
        bram[36] = 32'h0062a023;
        bram[37] = 32'h300002b7;
        bram[38] = 32'h00c28293;
        bram[39] = 32'h0002a483;
        bram[40] = 32'h300002b7;
        bram[41] = 32'h01028293;
        bram[42] = 32'h0002a903;
        bram[43] = 32'h300002b7;
        bram[44] = 32'h01428293;
        bram[45] = 32'h0002a983;
        bram[46] = 32'h03200513;
        bram[47] = 32'hf51ff0ef;
        bram[48] = 32'h00a00293;
        bram[49] = 32'h00549c63;
        bram[50] = 32'h00090a63;
        bram[51] = 32'h00098863;
        ...
        bram[58] = 32'h01828293;
        bram[59] = 32'h00100313;
        bram[60] = 32'h0062a023;
        bram[61] = 32'h00000413;
        bram[62] = 32'h00000e13;
        bram[63] = 32'h01000293;
        bram[64] = 32'h04545663;
        bram[65] = 32'h300002b7;
        bram[66] = 32'h0082a023;
        bram[67] = 32'h300002b7;
        bram[68] = 32'h00428293;
        bram[69] = 32'h0002a303;
        bram[70] = 32'h00400393;
        bram[71] = 32'h00734333;
        bram[72] = 32'h300002b7;
        bram[73] = 32'h00828293;
        bram[74] = 32'h0062a023;
        bram[75] = 32'h300002b7;
        bram[76] = 32'h00c28293;
        bram[77] = 32'h0002a383;
        bram[78] = 32'h00839463;
        bram[79] = 32'h0080006f;
        bram[80] = 32'h001e0e13;
        bram[81] = 32'h00140413;
        bram[82] = 32'hfb5ff06f;
        bram[83] = 32'h300002b7;
        bram[84] = 32'h01c28293;
        bram[85] = 32'h0002a483;
        bram[86] = 32'h03300513;
        bram[87] = 32'heb1ff0ef;
        bram[88] = 32'h000e1c63;
        bram[89] = 32'h01000293;
        bram[90] = 32'h00549863;
        bram[91] = 32'h05000513;
        bram[92] = 32'he9dff0ef;
        bram[93] = 32'h00c0006f;
        bram[94] = 32'h04600513;
        bram[95] = 32'he91ff0ef;
        bram[96] = 32'h00a00513;
        bram[97] = 32'he89ff0ef;
        bram[98] = 32'h002002b7;
        bram[99] = 32'hfff28293;
        bram[100] = 32'hfe029ee3;
        bram[101] = 32'he89ff06f;
    end
endmodule

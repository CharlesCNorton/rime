// MARK compositor test: RIME-I + MARK
module top (
    input  wire        clk,
    input  wire        usb_rx,
    output wire        usb_tx,
    ...
    initial begin
        ...
        bram[13] = 32'h0002a303;
        bram[14] = 32'hfe030ee3;
        bram[15] = 32'h00008067;
        bram[16] = 32'hfddff0ef;
        bram[17] = 32'h300002b7;
        bram[18] = 32'h0002a403;
        bram[19] = 32'h300002b7;
        bram[20] = 32'h00428293;
        bram[21] = 32'h0002a483;
        bram[22] = 32'h03100513;
        bram[23] = 32'hfb1ff0ef;
        bram[24] = 32'h00041863;
        bram[25] = 32'h04600513;
        bram[26] = 32'hfa5ff0ef;
        bram[27] = 32'h00c0006f;
        bram[28] = 32'h05000513;
        bram[29] = 32'hf99ff0ef;
        bram[30] = 32'hfa5ff0ef;
        bram[31] = 32'h300002b7;
        bram[32] = 32'h01028293;
        bram[33] = 32'h0002a403;
        bram[34] = 32'h03200513;
        bram[35] = 32'hf81ff0ef;
        bram[36] = 32'h00800313;
        bram[37] = 32'h00645863;
        bram[38] = 32'h05000513;
        bram[39] = 32'hf71ff0ef;
        bram[40] = 32'h00c0006f;
        bram[41] = 32'h04600513;
        bram[42] = 32'hf65ff0ef;
        bram[43] = 32'hf71ff0ef;
        bram[44] = 32'h300002b7;
        bram[45] = 32'h0002a403;
        bram[46] = 32'h300002b7;
        bram[47] = 32'h00428293;
        bram[48] = 32'h0002a483;
        bram[49] = 32'h00000913;
        bram[50] = 32'h00000993;
        bram[51] = 32'h00a00e13;
        bram[52] = 32'h03c9da63;
        bram[53] = 32'hf49ff0ef;
        bram[54] = 32'h300002b7;
        bram[55] = 32'h0002a303;
        bram[56] = 32'h300002b7;
        bram[57] = 32'h00428293;
        bram[58] = 32'h0002a383;
        bram[59] = 32'h00831663;
        bram[60] = 32'h00939463;
        bram[61] = 32'h0080006f;
        bram[62] = 32'h00190913;
        bram[63] = 32'h00198993;
        bram[64] = 32'hfd1ff06f;
        bram[65] = 32'h03300513;
        bram[66] = 32'hf05ff0ef;
        bram[67] = 32'h00091863;

...
module tiny_interp_pfb (
    ...
    // Variable part-select (program[pc*3 +: 3]) has caused synthesis issues.
        ...
        if (rst) begin
            ...
            if (pc >= PROG_LEN) begin
                ...
                case (opcode)
                    ...
                    3'd1: begin a <= 8'd0 - a;   pc <= pc + 4'd1; end  // NEG
                    3'd2: begin b <= a;           pc <= pc + 4'd1; end  // MOV (A→B)
